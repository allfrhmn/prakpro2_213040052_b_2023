    ...
    public MainTest() {
        ...
        buttonAdd.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(radioButton1.isSelected() && radioButton2.isSelected()) {
                    JOptionPane.showMessageDialog(MainTest.this, "Hanya satu jenis kelamin dipilih!",
                    ...
                    JOptionPane.showMessageDialog(MainTest.this, "Pilih jenis kelamin terlebih dahulu!",
                    "Kesalahan", JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                if(nama.isEmpty() || nomorHP.isEmpty() || alamat.isEmpty()) {
                    JOptionPane.showMessageDialog(MainTest.this, "Semua input harus diisi!",
                    "Kesalahan", JOptionPane.ERROR_MESSAGE);
                }
                else {
                    // Mengonfirmasi sebelum melakukan penyimpanan data
                    int konfirmasi = JOptionPane.showConfirmDialog(MainTest.this, "Apakah anda yakin menyimpan data ?",
                    "Konfirmasi", JOptionPane.YES_NO_OPTION);
        ...
        buttonUpdate.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(nama.isEmpty() || nomorHP.isEmpty() || alamat.isEmpty()) {
                    ...
                    int konfirmasi = JOptionPane.showConfirmDialog(MainTest.this, "Apakah anda yakin mengubah data ?",
                            "Konfirmasi", JOptionPane.YES_NO_OPTION);
        ...
        buttonDelete.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(selectedRow >= 0) {
                    int option = JOptionPane.showConfirmDialog(MainTest.this, "Apakah anda yakin menghapus data ?",
                    "Konfirmasi", JOptionPane.YES_NO_OPTION);
                    
                    if(option == JOptionPane.YES_OPTION) {
                        // Memanggil metode deleteRow untuk menghapus isi data tabel
                        tableModel.delete(selectedRow);
                        JOptionPane.showMessageDialog(MainTest.this, "Data berhasil dihapus!", "Informasi", JOptionPane.INFORMATION_MESSAGE);
                    }
                }
                else {
                    JOptionPane.showMessageDialog(MainTest.this, "Pilih baris yang akan dihapus!",
        ...
        this.addWindowListener(new WindowAdapter() {
            ...
            public void windowClosing(WindowEvent e) {
                int konfirmasi = JOptionPane.showConfirmDialog(MainTest.this,
